...
public class InvalidRegistrationSD {
    ...
    @Given("^I am on Threely Registration page$")
    public void iAmOnThreelyRegistrationPage() {
    ...
    public void iEnterNameAsEmailAsPasswordAs(String anyText, String textFields, String value) {
        ...
        switch (textFields) {
            case "name":
                ...
                break;
            case "email address":
                registrationPage.enterEmailField(anyText);
                break;
            case "password":
    ...
    public void iVerifyInvalidEmailAddress(String button) {
